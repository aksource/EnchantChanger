...
public class Constants {
    ...
    public static final String EcExpBottlePNG = "textures/items/ex_exp_bottle.png";
    ...
    public static final String EcGuiHuge = "textures/gui/huge_materia_container.png";
    public static final String EcGuiMako = "textures/gui/mako_reactor_container.png";
    public static final String EcGuiMateriaWindow = "textures/gui/materializing_container.png";
