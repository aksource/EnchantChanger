...
public class EcRenderEntityItemCustom extends Render<EntityItem> {
    private RenderItem itemRenderer;
    private Random random = new Random();

    public EcRenderEntityItemCustom(RenderManager renderManagerIn, RenderItem itemRenderer) {
    ...
    public void doRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        int i = itemstack.stackSize == 0 ? 187 : Item.getIdFromItem(itemstack.getItem()) + itemstack.getMetadata();
