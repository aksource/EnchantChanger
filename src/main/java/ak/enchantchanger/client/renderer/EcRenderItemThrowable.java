...
public class EcRenderItemThrowable extends RenderSnowball<Entity> {
    private final float renderSize;
    private final RenderItem itemRenderer;

    public EcRenderItemThrowable(RenderManager renderManager, Item item, RenderItem renderItem, float size) {
