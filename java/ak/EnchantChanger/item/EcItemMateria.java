...
public class EcItemMateria extends EcItem {
    ...
    public static void teleportPlayer(World world, EntityPlayer entityplayer) {
        ...
        if (entityplayer.isSneaking()) {
            ...
            point = new Vec3(spawnPoint.getX() + 0.5D, spawnPoint.getY(), spawnPoint.getZ() + 0.5D);
...
//	{
//		int EnchantmentKind = EnchantmentUtils.getEnchantmentId(item);
...
//				magic.addEnchantment(Enchantment.field_180311_a[magicEnch[i]], 1);
            itemList.add(magic);
        }
    }
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
        ...
        if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT)) {
            ...
            if (par1ItemStack.isItemEnchanted()) {
                Enchantment enchantment = EnchantmentUtils.getEnchantmentFromItemStack(par1ItemStack);
    ...
    public boolean isMagicEnch(Enchantment enchantment) {
        return EnchantmentUtils.magicEnchantmentSet.contains(enchantment);
    }
    ...
    public EnumRarity getRarity(ItemStack item) {
        if (item.getItemDamage() > 0)
            ...
            if (EnchantmentUtils.getEnchantmentId(item) == 256 || EnchantmentUtils.getEnchantmentLv(item) < 6)
...
//		if (kind < 5)
//			var6.addEnchantment(Enchantment.func_180306_c(ConfigurationUtils.idEnchantmentMeteor + kind), 1);
