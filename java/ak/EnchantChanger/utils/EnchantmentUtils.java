...
public class EnchantmentUtils {
    ...
    private static void initHugeMateriasMap() {
        ...
        MasterMateriaUtils.registerHugeMateria(2, new ItemStack(Items.fishing_rod), getEnchantedItemStack(materiaStack.copy(), Enchantment.field_151370_z, 1));
        MasterMateriaUtils.registerHugeMateria(2, new ItemStack(Items.carrot_on_a_stick), getEnchantedItemStack(materiaStack.copy(), Enchantment.field_151369_A, 1));
