...
public class EcRenderApOrb extends Render
{
    ...
    public void renderTheAPOrb(EcEntityApOrb par1EntityXPOrb, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
        ...
        float f9 = 255.0F;
        float f10 = ((float)par1EntityXPOrb.apColor + par9) / 2.0F;
    ...
    protected ResourceLocation getExperienceOrbTextures(EcEntityApOrb par1EntityXPOrb)
    {
    ...
    {
        return this.getExperienceOrbTextures((EcEntityApOrb)par1Entity);
    }
